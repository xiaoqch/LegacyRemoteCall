...
ll.exports((data, jsonStr) => {
    try {
        ...
        if (deepEqual(data, result)) {
            const forwardJsonType = ll.imports(TEST_EXPORT_NAMESPACE, "forwardJsonType");
            ...
            if (!deepEqual(result, forwarded1)) {
                ...
                writeFileSync(`${dataDir}/forwarded1.json`, JSON.stringify(forwarded1));
    ...
    return false;
}, TEST_EXPORT_NAMESPACE, "lseCompareJson");
ll.exports((extra) => {
    if (extra === undefined) {
