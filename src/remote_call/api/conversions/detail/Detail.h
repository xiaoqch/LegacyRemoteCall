...
struct FromDynamicFn {
    template <typename T>
    [[nodiscard]] inline auto operator()(DynamicValue& dv, T& t) const
    ...
    template <typename T>
    [[nodiscard]] inline auto operator()(DynamicValue& dv) const
...
struct ToDynamicFn {
    template <typename T>
    [[nodiscard]] inline auto operator()(DynamicValue& dv, T&& val) const
